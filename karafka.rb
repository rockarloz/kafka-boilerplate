...
# If by any chance you've wanted a setup for Rails app,
# either run the `karafka:install` command again
# or refer to the install templates available in the source codes
...
class KarafkaApp < Karafka::App
  setup do |config|
    ...
    config.client_id = ENV['KAFKA_CLIENT_ID'] || 'karafka_api'
    config.logger = Rails.logger
  end

  # Comment out this part if you are not using instrumentation or you are not
